...
interface ParagraphsHelperInterface {
  ...
  /**
   * Checks if the paragraph can be removed.
   *
   * @param \Drupal\paragraphs\ParagraphInterface $paragraph
   *   The paragraph to check.
   *
   ...
   *   The access result.
   */
  public function allowDelete(ParagraphInterface $paragraph);
   ...
   *
   * @return bool
   *   TRUE if the paragraph was removed, FALSE otherwise.
   */
  public function delete(ParagraphInterface $paragraph);
