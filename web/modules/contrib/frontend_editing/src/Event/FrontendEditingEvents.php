...
final class FrontendEditingEvents {
  ...
  /**
   * Allows modules to change the access result for paragraph remove action.
   *
   * @Event
   *
   * @see \Drupal\frontend_editing\Event\ParagraphDeleteAccess
   */
  const FE_PARAGRAPH_DELETE_ACCESS = ParagraphDeleteAccess::class;
