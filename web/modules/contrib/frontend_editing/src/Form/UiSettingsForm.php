...
class UiSettingsForm extends ConfigFormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $config->set('filter_add_items', (bool) $form_state->getValue('filter_add_items'));
    $config->set('filter_add_items_threshold', $form_state->getValue('filter_add_items_threshold'));
    $config->save();
