      ...
      actionsElements.forEach(function (actionsElement) {
        ...
        actionsElement
          ...
          .forEach(function (editingElement, i) {
            ...
            if (editingElement.classList.contains('needs-confirmation')) {
              editingElement.addEventListener('click', async function (e) {
                e.preventDefault();
                ...
                if (shouldDelete) {
                  if (e.target.classList.contains('ajax-allowed')) {
                    ...
                    const ajaxEvent = new MouseEvent('mouseover');
