  ...
  Drupal.behaviors.actionsButtonBottom = {
    attach(context, settings) {
      const heightSettings =
        settings.frontend_editing.duplicate_action_links_height;
      setTimeout(function () {
        const actionsElementsBottom = context.querySelectorAll(
