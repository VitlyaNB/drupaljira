...
class __TwigTemplate_21c6aabd3fb3ac45f5566f098cd319e5 extends Template
{
        ...
        if (((($tmp = ($context["items"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp) || (($tmp = ($context["empty"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp))) {
            ...
            if ((($tmp = ($context["items"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 35
                    yield "<li";
                    yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 35), "html", null, true);
                    yield ">";
                    yield (string) $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, CoreExtension::getAttribute($this->env, $this->source, $context["item"], "value", [], "any", false, false, true, 35), "html", null, true);
                    yield "</li>";
                }
    ...
    {
        return array (  85 => 39,  80 => 37,  69 => 35,  65 => 34,  60 => 33,  58 => 32,  53 => 29,  51 => 28,  49 => 27,  46 => 25,  44 => 24,);
    }
